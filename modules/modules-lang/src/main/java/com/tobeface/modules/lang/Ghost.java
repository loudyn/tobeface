...
import com.tobeface.modules.lang.born.Bornings;
import com.tobeface.modules.lang.eject.Ejector;
import com.tobeface.modules.lang.eject.Ejectors;
import com.tobeface.modules.lang.inject.Injector;
import com.tobeface.modules.lang.inject.Injectors;
import com.tobeface.modules.lang.invoke.Invokers;
...
public final class Ghost<T> {
	 ...
	 * @return
	 */
	public Ejector ejector(Object who, Field field) {
		return Ejectors.newFieldEjector(who, field);
	}
	 ...
	 * @return
	 */
	public Injector injector(Object who, Field field) {
	...
	public Class<?> genericsType(Class<?> superClazz) {
		Class<?>[] types = genericsTypes(superClazz);
		if (types.length == 0) {
			return Object.class;
		}
